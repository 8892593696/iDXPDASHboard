...
import com.pilog.mdm.cloud.Service.DashBoardsService;
...
public class DashBoardsController {
    ...
    @RequestMapping(value = {"/dataDXPAnalytics"}, method = {RequestMethod.POST, RequestMethod.GET}, produces = {
        "application/json"})
    public @ResponseBody
    JSONObject getDXPAnalyticstabsData(HttpServletRequest request) {
        ...
        try {
            ...
            if (viewFlag != null && !"".equalsIgnoreCase(viewFlag)) {
                result = dashBoardsService.getDataVisualizationLayout(request);
            } else {
                result = dashBoardsService.getVisualizationLayout(request);
            }
    ...
    public @ResponseBody
    JSONObject getTreeDataMigrationConnections(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
            String menuResult = "";
    ...
    public @ResponseBody
    JSONObject importDMFileXlsx(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    List getFileObjectData(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    String getLoadTableColumns(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject fetchChartData(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject fetchFiltersValues(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject fetchSlicerValues(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject fetchSlicerButtonValues(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject fetchSlicerListValues(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject fetchSlicerDropdownValues(HttpServletRequest request,
    ...
    public @ResponseBody
    JSONObject fetchCardDetails(HttpServletRequest request) {
    ...
    public @ResponseBody
    JSONObject fetchHomeCardDetails(HttpServletRequest request) {
    ...
    public @ResponseBody
    String getchartElement(HttpServletRequest request) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getchartchildElement(HttpServletRequest request) {
        String result = "";
        try {
    ...
    public @ResponseBody
    JSONObject fetchpredictiveChartData(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    String saveVisualizeData(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject getChartData(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject getfiletColumnData(HttpServletRequest request) {
    ...
    @RequestMapping(value = {"/getchartGrid"}, method = {RequestMethod.POST,
        RequestMethod.GET}, produces = "application/json")
    public @ResponseBody
    JSONObject getchartGrid(HttpServletRequest request) {
    ...
    public @ResponseBody
    List ChartGridResults(HttpServletRequest request) {
    ...
    public @ResponseBody
    String deleteVisualizeChart(HttpServletRequest request) {
        String result = "";
    ...
    public @ResponseBody
    String updatechartdata(HttpServletRequest request) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/dashboardSetting", method = {RequestMethod.POST,
        RequestMethod.GET}, produces = "application/json")
    public @ResponseBody
    JSONObject dashboardSetting(HttpServletRequest request) {
        String result = "";
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getconfigobject", method = {RequestMethod.POST,
        RequestMethod.GET}, produces = "application/json")
    public @ResponseBody
    JSONObject getconfigobject(HttpServletRequest request) {
        String result = "";
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getChartFilterData(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getHomeChartSlicerData(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject fetchHomeSlicerValues(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject getSlicerHomeCharts(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject movingAvgData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    String insertdata(HttpServletRequest request) {
        String Result = "";
        try {
    ...
    public @ResponseBody
    JSONObject getlandingGraphData(HttpServletRequest request) {
    ...
    public @ResponseBody
    String getdashbordname(HttpServletRequest request) {
        String Result = "";
        try {
...
//	}
    ...
    public @ResponseBody
    String updatechartSettingdata(HttpServletRequest request) {
        String result = "";
        try {
    ...
    public @ResponseBody
    JSONObject getSchemaObjectMetaData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getAnalyticsObjectData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONArray getSchemaObjectData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
    ...
    @RequestMapping(value = "/chartgridUpdateRecords", method = {RequestMethod.GET, RequestMethod.POST})
    public @ResponseBody
    String gridUpdateRecords(HttpServletRequest request) {
        String result = "";
        JSONObject resultObj = new JSONObject();
    ...
    @RequestMapping(value = "/saveHomeChartsColorsData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject saveHomeChartsColorsData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getSurveyHomeCharts(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/updteCompareFilterColumn", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String updteCompareFilterColumn(HttpServletRequest request) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/updteCompareFilterColumnsData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String updteCompareFilterColumnsData(HttpServletRequest request,
            HttpServletResponse response) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getDrillDownFilterColumns(HttpServletRequest request) {
        JSONObject jsonresult = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getHomeChartHeaderFilterForm(HttpServletRequest request,
            HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/updteFilterColumn", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String updteFilterColumn(HttpServletRequest request) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/createFilterHeader", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject createFilterHeader(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getChartHomePageDiv", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getChartHomePageDiv(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/showDrillDownChart", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject showDrillDownChart(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getcolorpalleteform", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getcolorpalleteform(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getChartColumnsForm(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/saveChartRadioButtonColumns", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String chartRadioButtonColumnForm(HttpServletRequest request) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/getchartconfigobjdata", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getchartconfigobjdata(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/updateGraphProperties", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject updateGraphProperties(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getTreeMapExchangeLevels", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getTreeMapExchangeLevels(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getExchaneLevelsData(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/createTableasFile", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject createTableasFile(HttpServletRequest request, HttpServletResponse response) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        try {
    ...
    @RequestMapping(value = "/deleteTableColumn", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String deleteTableColumn(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
    ...
    public @ResponseBody
    JSONObject mergeformdata(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    String transformdata(HttpServletRequest request) {
        String Result = "";
        try {
    ...
    @RequestMapping(value = "/gettransposedata", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String gettransposedata(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        String Result = "";
        try {
    ...
    public @ResponseBody
    String DimensionTransposeColumn(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        String Result = "";
        try {
    ...
    @RequestMapping(value = "/setImportData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    boolean setImportData(HttpServletRequest request) {
    ...
    public @ResponseBody
    JSONObject showtableData(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/gettableObjectData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONArray gettableObjectData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        try {
    ...
    public @ResponseBody
    String gettableattribute(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        String Result = "";
        try {
    ...
    @RequestMapping(value = "/caseSensitive", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String caseSensitive(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        String Result = "";
        try {
    ...
    @RequestMapping(value = "/DimensionTransposedata", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject DimensionTransposedata(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        JSONObject resultobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/generateQueryStr", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject generateQueryStr(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        JSONObject resultobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getModalFileColumns", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getModalFileColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject fetchModalChartData(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    String renameSQLColumn(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getAggregateResult(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String createSuffixAndPriffix(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/updatePalatteColor", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    String updatePalatteColor(HttpServletRequest request) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/getDataCorrelation", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getDataCorrelaltion(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = {"/getAutoSuggestedChartTypes"}, method = {RequestMethod.POST,
        RequestMethod.GET}, produces = {"application/json"})
    public @ResponseBody
    JSONObject getAutoSuggestedChartTypes(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = {"/getDateColumns"}, method = {RequestMethod.POST, RequestMethod.GET}, produces = {
        "application/json"})
    public @ResponseBody
    JSONObject getDateColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = {"/getQueryGridData"}, method = {RequestMethod.POST, RequestMethod.GET}, produces = {
        "application/json"})
    public @ResponseBody
    JSONObject getQueryGridData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getChartObjectData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONArray getChartObjectData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        try {
    ...
    @RequestMapping(value = "/viewAnalyticsTableGrid", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject viewAnalyticsTableDataGrid(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/viewAnalyticsTableGridData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONArray viewAnalyticsTableGridData(HttpServletRequest request) {
        JSONArray dataArray = new JSONArray();
        try {
    ...
    public @ResponseBody
    JSONObject executeSQLQuery(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = {"/getSuggestedChartTypesBasedonColumns"}, method = {RequestMethod.POST,
        RequestMethod.GET}, produces = {"application/json"})
    public @ResponseBody
    JSONObject getSuggestedChartTypesBasedonColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    String getCurrencyAndCodeList(HttpServletRequest request) {
    ...
    public @ResponseBody
    JSONObject getAutoSuggestedFilterTables(HttpServletRequest request,
            HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
    ...
    @RequestMapping(value = {"/getArtificialIntellisenseApiDetails"}, method = {RequestMethod.POST,
        RequestMethod.GET}, produces = {"application/json"})
    public @ResponseBody
    JSONObject getArtificialIntellisenseApiDetails(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject alterBiTable(HttpServletRequest request) {
    ...
    public @ResponseBody
    String getColumnformStr(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getSelectType(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getSuffixValue(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getPrefixValue(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getCreateFind(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String getRenameValue(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    JSONObject executeAlterTableColumn(HttpServletRequest request) {
    ...
    public @ResponseBody
    String createPrefixValue(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    String deleterowdata(HttpServletRequest request, HttpServletResponse response) {
        String result = "";
        try {
    ...
    public @ResponseBody
    JSONObject removeDuplicateValue(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject removeDuplicateEachColumn(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject deleteDuplicateValues(HttpServletRequest request) {
        JSONObject resultobj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject executePythonQuery(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getPythonChartObjectData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONArray getPythonChartObjectData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        try {
    ...
    @RequestMapping(value = {"/getCardDateValues"}, method = {RequestMethod.POST, RequestMethod.GET}, produces = {
        "application/json"})
    public @ResponseBody
    JSONObject getCardDateValues(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject saveFileOnServer(HttpServletRequest request,
    ...
    @RequestMapping(value = "/getCardImageData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONObject getCardImageData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    @RequestMapping(value = "/getCardImgData", method = {RequestMethod.GET,
        RequestMethod.POST}, produces = "application/json")
    public @ResponseBody
    JSONArray getCardImgData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        JSONArray dataArray = new JSONArray();
        try {
    ...
    public @ResponseBody
    JSONObject fetchChartJoinDxpTablesData(HttpServletRequest request) {
...
//            joinTablesData = dataPipingService.fetchJoinTablesData(request);
    ...
    String importDMFile(HttpServletRequest request, HttpServletResponse response,
            ...
            @RequestParam("fileLocalPath") String fileLocalPath,
    ...
    public @ResponseBody
    JSONObject getChatBotResponse(HttpServletRequest request) {
    ...
    public @ResponseBody
    JSONObject getUserTableNames(HttpServletRequest request) {
        JSONObject resultObject = null;
        try {
    ...
    public @ResponseBody
    JSONObject importIntelliSenseTreeChartsDMFileXlsx(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            String jsonDataStr = request.getParameter("jsonData");
            JSONObject jsonData = (JSONObject) JSONValue.parse(jsonDataStr);
            resultObj = dashBoardsService.importIntelliSenseTreeDMFileXlsx(request, response, jsonData, selectedFiletype);
    ...
    public @ResponseBody
    JSONObject createIntelliSenseTableasFile(HttpServletRequest request, HttpServletResponse response) {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseTableColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseChartTypes(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseChartColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseChartConfig(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseExampleChartDesign(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseChartSubColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseViewFilters(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseViewFiltersValues(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getIntelliSenseViewModalChartConfigOptions(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
            JSONObject jsonChartFilter = dashBoardsService.getChartFilters(request);
            resultObj.put("jsonChartFilterObj", jsonChartFilter);
    ...
    public @ResponseBody
    JSONObject getEditorMergeTableNames(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getEditorMergeTableColumns(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject checkExistMergeTableName(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject createTableANdJoinTables(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject insertMergeTablesData(HttpServletRequest request) {
        JSONObject resultObj = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getChatRplyResponse(HttpServletRequest request) {
        JSONObject resultObject = new JSONObject();
        try {
    ...
    public @ResponseBody
    JSONObject getConvAIMergeTableColumns(HttpServletRequest request) {
        JSONObject resultObject = new JSONObject();
        try {
    ...
    public @ResponseBody
    String updateCardData(HttpServletRequest request) {
    ...
    public @ResponseBody
    String deleteDashboard(HttpServletRequest request) {
        String result = "";
        try {
    ...
    @RequestMapping(value = "/getsearchChartData", method = {RequestMethod.GET, RequestMethod.POST})
    public @ResponseBody
    JSONObject getsearchChartData(HttpServletRequest request, HttpServletResponse response) {
        JSONObject TablesDataobj = new JSONObject();
        try {
            TablesDataobj = dashBoardsService.getsearchChartData(request);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return TablesDataobj;
...
//	}
    ...
    @RequestMapping(value = {"/downloadChartImagePDF"}, method = RequestMethod.POST)
    public void downloadSingleGoogleChartInPDF(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
        try {
            String filename = "Chart.pdf";
            String imageStr = request.getParameter("imageData");
            if (imageStr != null && !imageStr.isEmpty()) {
                dashBoardsService.chartInPDF(imageStr, response, model, request, filename);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @RequestMapping(value = {"/downloadJqxChartImagePDF"}, method = RequestMethod.POST)
    public void downloadSingleJQXChartInPDF(HttpServletRequest request, HttpServletResponse response, ModelMap model) {
        try {
            String filename = "JQXchart.pdf";
            String imageStr = request.getParameter("jqxImageData1");
            if (imageStr != null && !imageStr.isEmpty()) {
                dashBoardsService.chartInPDF(imageStr, response, model, request, filename);
            }
        } catch (Exception e) {
